    ...
    <div class="todo">
        <form method="post" action="1ejercicio.php">
            ...
            <div class="input-group">
                ...
                <input type="number" id="parcial3" name="parcial3" required>
            </div>

            <div class="input-group">
                <label for="examen">Examen final:</label>
                <input type="number" id="examen" name="examen" required>
            </div>

            <div class="input-group">
                <label for="trabajo">Trabajo final:</label>
                <input type="number" id="trabajo" name="trabajo" required>
            </div>
